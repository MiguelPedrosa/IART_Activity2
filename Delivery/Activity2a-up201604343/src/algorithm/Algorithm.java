...
public class Algorithm {
    ...
    private void addChildNodes(Node parentNode) {
        ...
        if(parentNode.getBoard().canMoveUp()) {
            ...
            Node childNode = new Node(childBoard, parentNode, "move piece Upmost to '0'", depth +1,  newNodeCost);
        ...
        if(parentNode.getBoard().canMoveDown()) {
            ...
            childBoard.moveDown();
            final int newNodeCost = cost + this.costFunction.compare(initialBoard, childBoard);
            Node childNode = new Node(childBoard, parentNode, "move piece Downmost to '0'", depth +1,  newNodeCost);
            if(!alreadyExploredNodes.contains(childNode) && !unexploredNodes.contains(childNode)) {
                unexploredNodes.add(childNode);
                alreadyExploredNodes.add(childNode);
            }
        ...
        if(parentNode.getBoard().canMoveRight()) {
            ...
            final int newNodeCost = cost + this.costFunction.compare(initialBoard, childBoard);
            Node childNode = new Node(childBoard, parentNode, "move piece Rightmost to '0'", depth +1,  newNodeCost);
            if(!alreadyExploredNodes.contains(childNode) && !unexploredNodes.contains(childNode)) {
                unexploredNodes.add(childNode);
                alreadyExploredNodes.add(childNode);
            }
        ...
        if(parentNode.getBoard().canMoveLeft()) {
            ...
            childBoard.moveLeft();
            final int newNodeCost = cost + this.costFunction.compare(initialBoard, childBoard);
            Node childNode = new Node(childBoard, parentNode, "move piece Leftmost to '0'", depth +1,  newNodeCost);
            if(!alreadyExploredNodes.contains(childNode) && !unexploredNodes.contains(childNode)) {
                unexploredNodes.add(childNode);
                alreadyExploredNodes.add(childNode);
            }
